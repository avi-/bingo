...
namespace AudioPlaybackAgent1
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        {
            // Windev : This is radio url I am trying. Check it on web first. When u run the app same thing plays.
            // It takes 3-4 secs to play. 
            new AudioTrack(new Uri("http://relay.radioreference.com/346246215", UriKind.RelativeOrAbsolute),
                            "Title 3",
                            "Artist",
                            "Album",
                            null),
            // Windev : uncomment below tracks if u want to here original sine waves.
