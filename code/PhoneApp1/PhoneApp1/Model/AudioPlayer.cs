...
namespace MyAudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        public void getTrack(string title,string artist, string album, string uri)
        {
            _playlist = new AudioTrack(new Uri(uri, UriKind.Absolute), title, artist, album, new Uri("Episode29.jpg", UriKind.Relative));
        }
